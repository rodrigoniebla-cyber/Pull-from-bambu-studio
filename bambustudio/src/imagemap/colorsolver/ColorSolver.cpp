...
// Origin file:   deps_src/colorsolver/ColorSolver.cpp (release v1.0.22, commit 92548381056dbf72836b0a1bdc455f238218dbfb)
// License:       GNU Affero General Public License v3 (AGPLv3) — original header preserved below.
